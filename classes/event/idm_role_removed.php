 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 **/
class idm_role_removed extends \core\event\base
{
    ...
    {
        return get_string('eventidm_role_removed', 'local_idmnotify');
    }

    public function get_description()
    {
        return "IDM received drop command for user '{$this->relateduserid}' in course '{$this->courseid}'.";
    }
    ...
    public function get_legacy_logdata()
    {
        ...
        return array($this->courseid, 'idmnotify', 'drop',
            '', '',
